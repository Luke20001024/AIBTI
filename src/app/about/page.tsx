  ...
  return (
    <main className="page-shell">
      <section className="section">
        ...
        <p className="section-copy">ArcBTI 不是心理诊断，也不是 MBTI 的官方衍生产品｜18 道短题把空间本能、空间价值和建筑直觉映射到 8 种建筑语言，让非专业读者获得一条进入建筑史的轻入口</p>
      </section>

      <section className="section about-list">
        <div><h2>怎么算</h2><p>答案进入秩序、风险、表达、关系、几何、场所、建造、时间八个维度；空间本能、空间价值与建筑直觉三组证据再与八种建筑语言原型进行相似度匹配｜结果仅作文化娱乐，不用于招聘、诊断或重要决策</p></div>
