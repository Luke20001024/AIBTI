  ...
  return (
    <main className="page-shell">
      <section className="section">
        ...
        <p className="section-copy">AIBTI 不是心理诊断，也不是 MBTI 的官方衍生产品。它用 18 道短题把潜意识投射、日常人格和建筑直觉映射到 8 个原创建筑人格，目的，是让非专业读者获得一条进入建筑史的轻入口。</p>
      </section>

      <section className="section about-list">
        <div><h2>怎么算</h2><p>答案进入秩序、风险、表达、社交、几何、场所、建造、时间八个维度；三类题目的权重分别为 25%、35%、40%，再与八种人格原型做余弦相似度匹配。结果是文化娱乐内容，不应用于招聘、诊断或重要决策。</p></div>
        ...
        <div><h2>隐私</h2><p>答案默认只保存在当前浏览器，并被压缩进可选的结果链接中；MVP 没有账号、数据库和用户画像上传。分享链接本身包含答案短码，不希望他人查看答案倾向时，请只分享生成的结果图片。</p></div>
      </section>
