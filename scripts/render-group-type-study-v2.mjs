...
const source = path.join(root, "docs", "design", "marketing-posters-xhs-v2", "group-type-study.html");
const outDir = path.join(root, "artifacts", "qa", "xhs-posters-v2");
const output = path.join(outDir, "group-poster-mobile-type-study-v1.png");
